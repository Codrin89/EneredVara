(function() {
	...
	function renderItems() {
		for(var i = 0 ; i < items.length ; i++) {
            ...
            wrapperDiv.appendChild(lastnameElement);
            wrapperDiv.appendChild(ageElement);
            wrapperDiv.appendChild(occupationElement);
            wrapperDiv.appendChild(nationalityElement);
            document.getElementsByClassName('itemContainer')[0].appendChild(wrapperDiv);
