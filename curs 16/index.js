(function(){
	...
	function createPersonItem(value) {
		for(var i = 0 ; i < value.length ; i++) {
			...
			// <h6>General info:</h6>
			var GeneralInfonfoElement = document.createElement('h6');
			...
			divItem.append(birth_yearItem);
			divItem.append(genderItem);
			divItem.append(homeworldItem);
