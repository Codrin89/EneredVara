...
document.getElementById('button').addEventListener('click', function() {
	...
	if(sum > 20) {
		document.getElementById('ex6').innerHTML ='Suma acestor doua numere este mai mare de 20';
		}
		else{
			document.getElementById('ex6').innerHTML ='Suma acestor numere este mai mica de 20';
		}
