(function() {
	...
	function createBoxes() {
		for(var i = 0 ; i < items.length ; i++) {
			var boxDiv = $('<div class="boxItem"><div class="imageBoxItem"><img src="img/img1.png"><div class="overlay"></div></div><div class="detailsBoxItem"><h4 class="title">' + items[i].title + '</h4></div></div>');
