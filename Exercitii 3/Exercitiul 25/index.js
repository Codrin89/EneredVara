	...
	function checkPasswordRegex() {
		...
		if(passwordInput.length > 8) {
			...
			if(specialCharsAndEverything) {
				document.getElementById('password-strength-label').innerHTML = 'Upper and lower + numbers + special chars';
			}
			if(numbersAndLowerUpperCase) {
				document.getElementById('password-strength-label').innerHTML = 'Upper and lower + numbers';
			}
			...
			document.getElementById('password-strength-label').innerHTML = 'Write some more!';
		}
