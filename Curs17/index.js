(function() {
    ...
    xhrPlanet.open("GET", 'https://swapi.co/api/planets', true);
    ...
    function createPlanetItem(value) {
        for (var i = 0; i < value.length; i++) {
            ...
            anchorToSinglePlanetItem.append(anchorToSinglePlanetItemItemText);
            ...
            divItemPlanet.append(anchorToSinglePlanetItem);
