...
//3
    var letters = ["a", "b", "c", "dd", "e"];
    for (var i = 0; i < letters.length; i++) {
    	if(letters[i] != 'b' && letters[i] != 'c') {
    		letters.splice(i, 1);
    		i--;
    	}
...
//6
	document.getElementById('button').addEventListener('click',function() {
		...
		if(sum > 20) {
			document.getElementById("ex6").innerHTML = 'Suma acestor 2 numere este mai mare ca 20';
	
		}
		else {
			document.getElementById("ex6").innerHTML = 'Suma este mai mica ca 20';
		}
	});
